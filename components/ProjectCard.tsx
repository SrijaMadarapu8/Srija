      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="mt-auto">
          ...
          <div className="flex items-center gap-4 pt-4 border-t border-gray-100 dark:border-gray-800">
            <button className="flex items-center gap-2 text-sm font-semibold text-gray-700 dark:text-white hover:text-cyan-600 dark:hover:text-neon-cyan transition-colors">
              <ExternalLink size={16} /> Demo
            </button>
            <button className="flex items-center gap-2 text-sm font-semibold text-gray-700 dark:text-white hover:text-purple-600 dark:hover:text-neon-purple transition-colors">
              <Github size={16} /> Code
            </button>
          </div>
        </div>
