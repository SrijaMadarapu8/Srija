...
const Skills: React.FC = () => {
  return (
    <section id="skills" className="py-24 px-6 bg-cream dark:bg-tech-dark relative transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {SKILLS.map((category, idx) => (
            <motion.div
              ...
              className="bg-white dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 hover:bg-white dark:hover:bg-gray-900 hover:border-gray-300 dark:hover:border-gray-700 transition-all shadow-sm hover:shadow-md dark:shadow-none"
            >
