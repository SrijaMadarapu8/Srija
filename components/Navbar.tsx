...
const Navbar: React.FC<NavbarProps> = ({ theme, toggleTheme, currentView, onNavigate }) => {
      ...
      <div className="w-full px-8 md:px-12 flex justify-center items-center relative">
        ...
        <div className="hidden md:flex items-center space-x-12 lg:space-x-16">
          ...
          <div className="flex items-center space-x-6">
             <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors"><Github size={20} /></a>
             <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-white transition-colors"><Linkedin size={20} /></a>
        ...
        {isMobileMenuOpen && (
          <div className="fixed inset-0 bg-white dark:bg-tech-dark flex flex-col items-center justify-center space-y-8 z-40 transition-colors duration-300">
             <button
                ...
                className="text-2xl text-gray-900 dark:text-white font-bold tracking-widest hover:text-cyan-600 dark:hover:text-neon-cyan"
             >
               HOME
             </button>
            {navLinks.map((link) => (
            ...
            <div className="flex space-x-8 mt-8">
               <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors"><Github size={24} /></a>
               <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-white transition-colors"><Linkedin size={24} /></a>
